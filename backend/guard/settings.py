...
MIDDLEWARE = [
    ...
    "middleWares.rateLimit.GlobalRateLimitMiddleware",
    "middleWares.authenticate.UserAgentValidationMiddleware",
]

AUTHENTICATION_BACKENDS = [
    "axes.backends.AxesBackend",  # Check for locks first
    "django.contrib.auth.backends.ModelBackend",  # Then check credentials
]

# Axes Configurations
AXES_FAILURE_LIMIT = 5  # Lock out after 5 tries
AXES_COOLOFF_TIME = 1  # Wait 1 hour before trying again
# AXES_LOCK_OUT_BY_COMBINATION_USER_AND_IP = True  # Be precise with locks
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    # {
    #     "NAME": "password_validators.validators.PwnedPasswordValidator",
    # },
]
